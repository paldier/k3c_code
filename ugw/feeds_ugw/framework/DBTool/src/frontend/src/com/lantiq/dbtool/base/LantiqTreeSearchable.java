 ...
 * 
 */
public class LantiqTreeSearchable extends AbstractSearchable {
	 ...
	 */
	public LantiqTreeSearchable(JXTree tree) {
	 ...
	 * @param pattern
	 * @param row
	 *            a valid row index in view coordinates a valid column index in
	 *            view coordinates
	...
	protected void moveMatchBySelection() {
		...
		tree.setSelectionRow(lastSearchResult.getFoundRow());
		if (scroll)
			tree.scrollRowToVisible(lastSearchResult.getFoundRow());
	}
